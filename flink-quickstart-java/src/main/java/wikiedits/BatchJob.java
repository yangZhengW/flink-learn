...
//		writeToFile(binFile, "bin");
		final TextInputFormat format = new TextInputFormat(new Path("D:/flinkText"));
		...
		DataSet<String> text = env.readFile(format, "D:/flinkText");
        DataSet<Tuple2<String, Integer>> wordCounts = text
                .flatMap(new LineSplitter())
                .groupBy(0)
                .sum(1);
        wordCounts.print();
        wordCounts.writeAsText("D:/out", FileSystem.WriteMode.OVERWRITE);
		// execute program
